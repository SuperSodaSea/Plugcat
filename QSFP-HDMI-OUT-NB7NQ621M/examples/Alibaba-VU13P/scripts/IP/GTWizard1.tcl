...
set GTWIZARD1_PROPERTIES [concat $GTWIZARD1_PROPERTIES {
    ...
    CONFIG.CHANNEL_ENABLE { X1Y39 X1Y38 X1Y37 X1Y36 }
    CONFIG.TX_MASTER_CHANNEL X1Y37
    CONFIG.RX_MASTER_CHANNEL X1Y37
...
switch "$RESOLUTION@$REFRESH_RATE" {
    ...
    "1920x1080@144" {
        set GTWIZARD1_PROPERTIES [concat $GTWIZARD1_PROPERTIES {
            ...
            CONFIG.TX_PLL_TYPE QPLL0
            CONFIG.TX_QPLL_FRACN_NUMERATOR 7953174
            CONFIG.TX_REFCLK_FREQUENCY 161.132

            CONFIG.RX_LINE_RATE 3.564
            CONFIG.RX_PLL_TYPE QPLL0
            CONFIG.RX_QPLL_FRACN_NUMERATOR 7953174
