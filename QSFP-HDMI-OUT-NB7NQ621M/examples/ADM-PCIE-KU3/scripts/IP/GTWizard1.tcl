create_ip -module_name GTWizard1 -vendor xilinx.com -library ip -name gtwizard_ultrascale -version 1.7

set GTWIZARD1_PROPERTIES {}

set GTWIZARD1_PROPERTIES [concat $GTWIZARD1_PROPERTIES {
    ...
    CONFIG.CHANNEL_ENABLE { X1Y19 X1Y18 X1Y17 X1Y16 }
    CONFIG.TX_MASTER_CHANNEL X1Y17
    CONFIG.RX_MASTER_CHANNEL X1Y17

    CONFIG.TX_REFCLK_SOURCE { X1Y19 clk0 X1Y18 clk0 X1Y17 clk0 X1Y16 clk0 }
    CONFIG.RX_REFCLK_SOURCE { X1Y19 clk0 X1Y18 clk0 X1Y17 clk0 X1Y16 clk0 }
...
set_property -dict $GTWIZARD1_PROPERTIES [get_ips GTWizard1]
