...
set_property -dict { PACKAGE_PIN AD15 IOSTANDARD LVCMOS33 } [get_ports qsfp_modprsl]
set_property -dict { PACKAGE_PIN AD13 IOSTANDARD LVCMOS33 } [get_ports qsfp_intl]
set_property -dict { PACKAGE_PIN Y15 IOSTANDARD LVCMOS33 } [get_ports qsfp_modsell]
set_property -dict { PACKAGE_PIN AE13 IOSTANDARD LVCMOS33 } [get_ports qsfp_resetl]
set_property -dict { PACKAGE_PIN W14 IOSTANDARD LVCMOS33 } [get_ports qsfp_lpmode]
set_property -dict { PACKAGE_PIN AF13 IOSTANDARD LVCMOS33 } [get_ports qsfp_scl]
set_property -dict { PACKAGE_PIN AE15 IOSTANDARD LVCMOS33 } [get_ports qsfp_sda]
