...
# 156.25MHz
set_property PACKAGE_PIN T7 [get_ports qsfp_refclk_p]
set_property PACKAGE_PIN T6 [get_ports qsfp_refclk_n]
...
set_property -dict { PACKAGE_PIN G12 IOSTANDARD LVCMOS33 } [get_ports qsfp_modprsl]
set_property -dict { PACKAGE_PIN F12 IOSTANDARD LVCMOS33 } [get_ports qsfp_intl]
set_property -dict { PACKAGE_PIN F14 IOSTANDARD LVCMOS33 } [get_ports qsfp_modsell]
set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports qsfp_resetl]
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports qsfp_lpmode]
set_property -dict { PACKAGE_PIN F9 IOSTANDARD LVCMOS33 } [get_ports qsfp_scl]
set_property -dict { PACKAGE_PIN F10 IOSTANDARD LVCMOS33 } [get_ports qsfp_sda]
